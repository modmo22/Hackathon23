...
class MainMenu():
    ...
    def draw(self):
        ...
        BUTT1 = pygame.image.load(os.path.join('sprites', 'Butt1.png'))#unfinished
        ...
        BUTT2 = pygame.image.load(os.path.join('sprites', 'Butt2.png'))#unfinished
        ...
        BUTT3 = pygame.image.load(os.path.join('sprites', 'Butt3.png'))#unfinished
        ...
        BUTT4 = pygame.image.load(os.path.join('sprites', 'Butt4.png'))#unfinished
        ...
        BACKGROUND = pygame.image.load(os.path.join('sprites','TitleScreen.png'))#place holder image for now
